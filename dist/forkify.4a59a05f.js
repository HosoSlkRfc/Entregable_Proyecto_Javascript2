...
const controlRecipes = async function() {
    try {
        ...
        console.error(err);
        (0, _recipeViewJsDefault.default).renderError('Error cargando receta.');
    }
};
// 2) SEARCH
const controlSearchResults = async function() {
    try {
        ...
        console.error(err);
        (0, _resultsViewJsDefault.default).renderError('Error buscando recetas.');
    }
};
...
},{"./model.js":"3QBkH","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","./views/searchView.js":"kbE4Z","./views/resultsView.js":"kBQ4r","./views/recipeView.js":"3wx5k","./views/paginationView.js":"7NIiB"}],"3QBkH":[function(require,module,exports,__globalThis) {
// src/js/model.js
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
class ResultsView extends (0, _viewJsDefault.default) {
    ...
    _errorMessage = "No encontramos recetas. Prueba otra b\xfasqueda.";
    _message = '';
    _generateMarkup() {
...
class RecipeView extends (0, _viewJsDefault.default) {
    ...
    _errorMessage = 'No pudimos cargar esa receta. Intenta otra.';
    _message = '';
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","./View.js":"jSw21","url:../../img/icons.svg":"fd0vu"}],"7NIiB":[function(require,module,exports,__globalThis) {
